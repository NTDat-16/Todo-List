import { TASK_STATUS,EMPLOYEE_POSITION } from "./constants.js";
...
export class TaskStorage {
    ...
    saveTasks(tasks) {
    saveToStorage(this.#storageKey, tasks.map(task => task.toJSON()));
}
}
// employee
...
saveEmployees(employees) {
    saveToStorage(this.#storageKey, employees.map(e => e.toJSON()));
}
